...
interface MessageRepository {
     ...
     */
    suspend fun getMessage(id: com.novachat.feature.ai.domain.model.MessageId): Message?
...
interface AiRepository {
     ...
     */
    suspend fun isModeAvailable(mode: com.novachat.feature.ai.domain.model.AiMode): Boolean
...
interface PreferencesRepository {
     ...
     * @return Result.success if saved successfully, Result.failure on error
     */
    suspend fun updateAiMode(mode: com.novachat.feature.ai.domain.model.AiMode): Result<Unit>
     ...
     *
     * @param apiKey The API key to save (ignored - always cleared)
     * @return Result.success if saved successfully, Result.failure on error
     */
    suspend fun updateApiKey(apiKey: com.novachat.feature.ai.domain.model.ApiKey?): Result<Unit>
