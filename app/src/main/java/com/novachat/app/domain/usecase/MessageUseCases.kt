...
class UpdateAiConfigurationUseCase(
     ...
     */
    suspend operator fun invoke(configuration: com.novachat.app.domain.model.AiConfiguration): Result<Unit> {
...
class RetryMessageUseCase(
     ...
     */
    suspend operator fun invoke(messageId: com.novachat.app.domain.model.MessageId): Result<Message> {
